...
export default function FormularioAdotar() {
  ...
  const renderCurrent = () => {
    switch (majorStep) {
      ...
      case 2:
        return (
          <StepQuestionsGroup groupId={2} subStep={subStep} onAnswer={update} />
        );
      case 3:
        return (
          <StepQuestionsGroup groupId={3} subStep={subStep} onAnswer={update} />
        );
      case 4:
        return (
          <StepQuestionsGroup groupId={4} subStep={subStep} onAnswer={update} />
        );
      case 5:
        return (
          <StepFinal
