...
export default function Nav() {
  ...
  // --- LÓGICA DE ROLES ---
  const isAdmin =
    MODO_TESTE_ADMIN || (isAuthenticated && user && user.role === "ADMIN");
  const isOng =
    !MODO_TESTE_ADMIN && isAuthenticated && user && user.role === "ONG";
        ...
        <ul className={styles.navCategorias}>
          ...
          {isAdmin && (
            <>
              ...
              <li>
                <Link to="/admin/gerenciamento" className={styles.navLink}>
                  Gerenciamento
                </Link>
              </li>
              <li>
                <Link to="/admin/monitoramento" className={styles.navLink}>
                  Monitoramento
                </Link>
              </li>
              <li>
                <Link to="/admin/historico-pets" className={styles.navLink}>
          ...
          {isOng && (
            <>
              <li>
                <Link to="/doar" className={styles.navLink}>
                  Doação
                </Link>
              </li>
              <li>
                <Link to="/central-adocao" className={styles.navLink}>
                  Central de Adoção
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link to="/registrar-animal" className={styles.navLink}>
                  Registrar Animal
                </Link>
              </li>
              <li>
                <Link to="/voluntarios" className={styles.navLink}>
                  Voluntários
                </Link>
              </li>
            </>
