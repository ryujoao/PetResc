...
// --- IMPORTS DAS PÁGINAS (Mantive todos os seus) ---
...
import GerenciarAdocao from "./pages/gerenciar/gerenciarAdocao"; // Ajustei o caminho
...
function App() {
  return (
    <Routes>
      ...
      {/* ====================================================== */}
      {/* 🔒 ROTAS PRIVADAS (Requer Login: User ou ONG)          */}
      {/* ====================================================== */}
